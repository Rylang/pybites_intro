...
'pybites_intro'[0:2] gives 'py'.
The first value is inclusive and the last one is exclusive so
here we grab indexes 0 and 1, the letter p and y.
When you have a 0 index you can leave it out so can write this as 'pybites_intro'[:2]
but here is the kicker: you can use this on a list too!
['pybites_intro', 'teaches', 'you', 'Python'][-2:] would gives ['you', 'Python']
